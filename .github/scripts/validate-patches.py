...
# ///
"""
validate-patches — Validate all .patch files in a fork.
...
Usage:
    validate-patches --repo /path/to/mo
    validate-patches --repo /path/to/mo --verbose
    validate-patches --repo /path/to/mo --check-patched-files

Environment variables:
    FORK_SYNC_REPO     Path to fork repo (default: cwd)
"""
...
app = typer.Typer(
    ...
    help="Validate all .patch files in a fork.",
    add_completion=True,
...
def validate(
    ...
    """Validate all .patch files in the fork."""
